...
mostcommon = counter.most_common(maxwords)

vocab = {}
i = 1
for (word,_) in mostcommon:
  vocab[word] = i
  i = i+1
...
trainer = gluon.Trainer(model.collect_params(), optimizer, {'learning_rate': 0.001})
